  ...
  for await (const message of query({
    ...
    if (message.type === 'result') {
      ...
      if (modelUsage) {
        ...
        if (firstModel) {
          if (!detectedContextWindow && modelUsage[firstModel].contextWindow) {
            detectedContextWindow = modelUsage[firstModel].contextWindow!;
            log(`LCM: Detected context window: ${detectedContextWindow} tokens`);
          }
